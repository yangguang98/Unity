...
/// 控制层：国王AI
/// </summary>
public class KingAICommand : Command  {
    ...
    void Start()
    {
        ...
        attackDistance = UnityHelper.GetInstance().GetRandomNum(1, 2);
        cordonDistance = UnityHelper.GetInstance().GetRandomNum(4, 8);
        thinkInterval = UnityHelper.GetInstance().GetRandomNum(2, 3);
